 ...
 * @author btssio
 */
public class rapports_visite extends javax.swing.JFrame {

    /**
     * Creates new form rapports_visite
     */
    public rapports_visite() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rapports_visite.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rapports_visite().setVisible(true);
            }
        });
    }
