...
public interface JdbcInterface {
     ...
     * @param String requete : texte de la requête SQL non paramétrée
     ...
     * utile par exemple pour insérer simultanément dans deux tables liées par une 
     * référence sur cette clef
     * @param String requete : texte de la requête SQL paramétrée
     * @param List param : liste des valeurs des paramètres
     * @return Resultset contenant le dernier ID généré
     *
     */
	...
	*@param ResultSet rs résultat d'une requête sur la BD associée à la connexion
